...
import { Plane, Mail, Lock, Eye, EyeOff, User, AlertCircle, CheckCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-orange-900 flex items-center justify-center px-4 py-24">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Start booking in seconds</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" value={name} onChange={e => setName(e.target.value)}
                  placeholder="Rahim Uddin" required className="input-base pl-10" />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPass ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)}
                  placeholder="Min. 6 characters" required className="input-base pl-10 pr-10" />
            ...
            <div className="flex items-start gap-2 pt-1">
              ...
              <p className="text-xs text-slate-500">By registering you agree to our Terms of Service and Privacy Policy.</p>
            </div>
          ...
          <button onClick={handleGoogle}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl border-2 border-slate-200 hover:border-orange-200 hover:bg-orange-50 transition-all font-medium text-slate-700 text-sm">
